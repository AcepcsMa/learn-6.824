...
// Remove duplicates from the input slice.
func removeDuplicate(terms []string) []string {
...
func mapF(document string, value string) (res []mapreduce.KeyValue) {
	...
	result := make([]mapreduce.KeyValue, 0, len(terms))
	for _, term := range terms {
		result = append(result, mapreduce.KeyValue{Key: term, Value: document})
	}
	return result
}
